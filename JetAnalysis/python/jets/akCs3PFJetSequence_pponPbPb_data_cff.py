...
akCs3PFpfImpactParameterTagInfos = akCs3PFbTagger.pfImpactParameterTagInfos
...
akCs3PFpfSecondaryVertexTagInfos = akCs3PFbTagger.pfSecondaryVertexTagInfos
akCs3PFpfDeepCSVTagInfos = akCs3PFbTagger.pfDeepCSVTagInfos
akCs3PFpfDeepCSVJetTags = akCs3PFbTagger.pfDeepCSVJetTags
...
akCs3PFJetCandBtagging = cms.Sequence(akCs3PFpfImpactParameterTagInfos *
    akCs3PFpfSecondaryVertexTagInfos *
    akCs3PFpfDeepCSVTagInfos *
    akCs3PFpfDeepCSVJetTags
    )
...
akCs3PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akCs3PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akCs3PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akCs3PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akCs3PFpfDeepCSVJetTags:probbb"),
        ),

...
akCs2PFpfImpactParameterTagInfos = akCs2PFbTagger.pfImpactParameterTagInfos
...
akCs2PFpfSecondaryVertexTagInfos = akCs2PFbTagger.pfSecondaryVertexTagInfos
akCs2PFpfDeepCSVTagInfos = akCs2PFbTagger.pfDeepCSVTagInfos
akCs2PFpfDeepCSVJetTags = akCs2PFbTagger.pfDeepCSVJetTags
...
akCs2PFJetCandBtagging = cms.Sequence(akCs2PFpfImpactParameterTagInfos *
    akCs2PFpfSecondaryVertexTagInfos *
    akCs2PFpfDeepCSVTagInfos *
    akCs2PFpfDeepCSVJetTags
    )
...
akCs2PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akCs2PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akCs2PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akCs2PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akCs2PFpfDeepCSVJetTags:probbb"),
        ),

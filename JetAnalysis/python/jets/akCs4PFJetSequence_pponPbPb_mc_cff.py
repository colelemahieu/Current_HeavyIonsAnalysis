...
akCs4PFpfImpactParameterTagInfos = akCs4PFbTagger.pfImpactParameterTagInfos
...
akCs4PFpfSecondaryVertexTagInfos = akCs4PFbTagger.pfSecondaryVertexTagInfos
akCs4PFpfDeepCSVTagInfos = akCs4PFbTagger.pfDeepCSVTagInfos
akCs4PFpfDeepCSVJetTags = akCs4PFbTagger.pfDeepCSVJetTags
...
akCs4PFJetCandBtagging = cms.Sequence(akCs4PFpfImpactParameterTagInfos *
    akCs4PFpfSecondaryVertexTagInfos *
    akCs4PFpfDeepCSVTagInfos *
    akCs4PFpfDeepCSVJetTags
    )
...
akCs4PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akCs4PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akCs4PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akCs4PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akCs4PFpfDeepCSVJetTags:probbb"),
        ),

  ...
  effectiveAreas_( (ps.getParameter<edm::FileInPath>("effAreasConfigFile")).fullPath() )
{
  ...
  if (doCaloTower_){
    ...
    tree_->Branch("hfmMax_eta",            &hfmMax_eta);
    tree_->Branch("hfmMax_phi",            &hfmMax_phi);
    tree_->Branch("hfpMax",                &hfpMax);
    tree_->Branch("hfpMax_eta",            &hfpMax_eta);
    tree_->Branch("hfpMax_phi",            &hfpMax_phi);
    tree_->Branch("CaloTower_e",           &CaloTower_e_);
    tree_->Branch("hfp_avg1", &hfp_avg1);
    tree_->Branch("hfp_avg2", &hfp_avg2);
    tree_->Branch("hfp_avg3", &hfp_avg3);
    tree_->Branch("hfp_avg4", &hfp_avg4);
    tree_->Branch("hfp_avg5", &hfp_avg5);
    tree_->Branch("hfp_avg6", &hfp_avg6);
    tree_->Branch("hfp_avg7", &hfp_avg7);
    tree_->Branch("hfp_avg8", &hfp_avg8);
    tree_->Branch("hfp_avg9", &hfp_avg9);
    tree_->Branch("hfp_avg10", &hfp_avg10);
    tree_->Branch("hfp_avg11", &hfp_avg11);
    tree_->Branch("hfp_avg12", &hfp_avg12);
    tree_->Branch("hfp_avg13", &hfp_avg13);
    tree_->Branch("hfm_avg1", &hfm_avg1);
    tree_->Branch("hfm_avg2", &hfm_avg2);
    tree_->Branch("hfm_avg3", &hfm_avg3);
    tree_->Branch("hfm_avg4", &hfm_avg4);
    tree_->Branch("hfm_avg5", &hfm_avg5);
    tree_->Branch("hfm_avg6", &hfm_avg6);
    tree_->Branch("hfm_avg7", &hfm_avg7);
    tree_->Branch("hfm_avg8", &hfm_avg8);
    tree_->Branch("hfm_avg9", &hfm_avg9);
    tree_->Branch("hfm_avg10", &hfm_avg10);
    tree_->Branch("hfm_avg11", &hfm_avg11);
    tree_->Branch("hfm_avg12", &hfm_avg12);
    tree_->Branch("hfm_avg13", &hfm_avg13);
